...
public class HandleDropdown2 {
	...
	public void VerifyDefaultOption() {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\pkharatm\\Downloads\\chromedriver.exe");
		...
		WebElement selected_value1=month_value.getFirstSelectedOption();
		System.out.println("Print the before value: "+selected_value1.getText());
		month_value.selectByValue("5");
		WebElement selected_value2=month_value.getFirstSelectedOption();
		System.out.println("Print the after value: "+selected_value2.getText());
